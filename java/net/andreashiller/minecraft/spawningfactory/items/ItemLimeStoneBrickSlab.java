...
public class ItemLimeStoneBrickSlab extends ItemBlock
{
    ...
    public ItemLimeStoneBrickSlab(Block block)
    {
        super(block);
        this.field_150949_c = (BlockSlab)BlockHandler.blockLimeStoneBrickHalfSlab;
        this.field_150947_d = (BlockSlab)BlockHandler.blockLimeStoneBrickDoubleSlab;
